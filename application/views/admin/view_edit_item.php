                    ...
                    <div class="header">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <div class="button" style="margin-top: -17px">
                                <a href="<?=base_url('admin/item')?>" class="btn  bg-red btn-circle-lg waves-effect waves-circle waves-float"><i class="material-icons">keyboard_backspace</i></a>
                            </div>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <label class="form-label">Jenis Item<small> *</small></label>
                                      <div class="form-group form-float">
                                        <div class="form-line">
                                            <select name="jenis_item" id="kategori" class="form-control show-tick">
                            ...
                            <a class="btn btn-danger waves-effect" href="<?=base_url('admin/item')?>">Batal</a>
