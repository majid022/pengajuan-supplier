                                    ...
                                    <tbody>
                                        ...
                                        foreach ($item as $key) { ?>
                                            <tr>
                                                <td><?= $i ?></td>
                                                <td>
                                                    <input type="checkbox" id="basic_checkbox_<?=$ik++?>" name="item[]" value="<?=$key->id_item?>" class="filled-in">
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admin/approval_item/detailItem/'.$key->id_item) ?>" class="btn btn-success ">
                                                        Detail
                                                    </a>
                                                </td>
                                            </tr>
