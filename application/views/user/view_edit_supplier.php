                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                             <input name="dos1" style="text-transform: uppercase;" value="<?=$sup->dos1?>"  required="" type="date" class="form-control" placeholder="Tanda Tangan">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 ">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                             <input name="dos2" style="text-transform: uppercase;"  value="<?=$sup->dos2?>"  required="" type="date" class="form-control" placeholder="Tanda Tangan">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 ">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                             <input name="dos3" style="text-transform: uppercase;" value="<?=$sup->dos3?>"  required="" type="date" class="form-control" placeholder="Tanda Tangan">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="nomor_ktp" value="<?=$sup->nomor_ktp?>" type="text" class="form-control"  maxlength="16" minlength="16" style="text-transform: uppercase;" required placeholder="Masukkan Nomor KTP">
                                        </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="nomor_npwp" value="<?=$sup->nomor_npwp?>" type="text" class="form-control"  maxlength="15" minlength="15" style="text-transform: uppercase;" required placeholder="Masukkan Nomor NPWP">
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="alamat" value="<?=$sup->alamat?>" type="text" class="form-control" minlength="3" required placeholder="Otomatis Terisi" readonly="" style="text-transform: uppercase;">
                                        </div>
                                    </div>
                                    <label class="form-label">Nama Gedung<small> *</small></label>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="nama_gedung" value="<?=$sup->nama_gedung?>" type="text" class="nama_gedung form-control"  required placeholder="Masukkan Nama Gedung " style="text-transform: uppercase;">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group form-float" data-size="10" data-live-search="true">
                                        <div class="form-line">
                                            <select name="nama_departement" id="nama_departement" class="form-control show-tick">
                                    ...
                                    <div class="form-group form-float" data-size="10" data-live-search="true">
                                        <div class="form-line">
                                            <select name="nama_intercompany" id="nama_intercompany" class="form-control show-tick">
