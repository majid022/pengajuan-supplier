<section class="content">
    <div class="container-fluid">
       <div class="row clearfix">
        ...
        <!-- Advanced Validation -->
        <form id="form_advanced_validation" action="<?=base_url('user/item/aksi_tambah')?>" method="POST" enctype="multipart/form-data">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" style="text-transform: uppercase;" placeholder="Masukkan Nama requester" class="form-control" name="nama_re" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 ">
                                   <label class="form-label">Tanggal Pengajuan<small> *</small></label>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                             <input type="date" class="form-control" placeholder="Ex: 30/07/2016" name="tgl_pen">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="des_item" id="" type="text" class="form-control" style="text-transform: uppercase;" required placeholder="Masukkan Deskripsi item">
                                        </div>
                                    </div>
                                    ...
                                    <label class="form-label">Jenis Satuan<small> *</small></label>
                                      <div class="form-group form-float">
                                        <div class="form-line">
                                            <select name="satuan" id="kategori" class="form-control show-tick" data-size="10" data-live-search="true">
                                                <option value="">-- Pilih Satuan --</option>
                                                <?php foreach($satuan as $sa){?>
                                                <option value="<?=$sa->nama_uom?>"><?=$sa->nama_uom?></option>
                                                <?php }?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="harga" maxlength="20" minlength="3" required placeholder="Masukkan Harga Item" style="text-transform: uppercase;">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-line">
                                            <select name="des_coa" id="des_coa" class="form-control show-tick" data-size="10" data-live-search="true">
                                                ...
                                                <?php foreach($des_coa as $c){?>
                                                    <option value="<?=$c->kode_account?>"><?=$c->nama_account?></option>
                                                <?php }?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="kode_account"  maxlength="20" id="kode_account" minlength="3" readonly="" required placeholder="Otomatis terisi" style="text-transform: uppercase;">
                                        </div>
                                    </div>
                                    <label class="form-label">Jenis Item<small> *</small></label>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="jenis_item_coa" id="jenis_item_coa" maxlength="20" minlength="3" readonly="" required placeholder="Otomatis terisi" style="text-transform: uppercase;">
                                        </div>
                                    </div>
                                </div>
                            </div>
